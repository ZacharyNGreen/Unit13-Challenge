...
def get_investment_recommendation(risk_level):
    #returns reccomendation based on risk tolerance
    risk_levels = {
...
def validate_data(age, investment_amount, intent_request):
    ...
    # Validate that the investment amount is at least 5000
...
def recommend_portfolio(intent_request):
    #dialgoue managemetn for portfolio
